...
import { UploadRequestDataPanel } from "./upload-request-data-panel";
    ...
    <div className="grid min-w-0 gap-4 xl:grid-cols-[minmax(0,420px)_minmax(0,1fr)]">
      ...
      >
        ...
        <div className="p-4">
          ...
          <UploadRequestDataPanel
            manualFormDocuments={manualFormDocuments}
            uploadedAttachments={uploadedAttachments}
            ...
            parseFile={parseFile}
            onFocusDocument={(documentId) =>
              setActiveWorkflowNodeId(
                requestWorkflowNodeByDocumentId.get(documentId) || requestSubmitNodeId,
              )
            }
            onFocusParsedFields={() => setActiveWorkflowNodeId(requestSubmitNodeId)}
          />
          {hasSubmissionDraft && (
